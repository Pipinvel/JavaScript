...
//alert(a+b);
//23.2
// let str=parseFloat('5.5px');
// let str2=parseFloat('6.25px');
// alert(str+str2+"px");
...
//27.2
// let str='abcde';
// let result= str[4]+str[3]+str[2]+str[1]+str[0];
// alert(result);
//27.3
// let str='abcde';
// let num=2;
...
//28.1
//let str='dzhfh;elbvzsletuy';
//alert(str[str.length-1]);
//28.2
// let str='abcdesngiziguwh';
...
//33.4
// let a=prompt('Введите 1 сторону прямоугольника');
// let b=prompt('Введите 2 сторону прямоугольника');
// alert('Периметр прямоугольника равен:' + ' ' + (2*(+a + +b)));
...
// console.log(arr[0][0] + arr[0][1] + arr[0][2] + arr[0][3][0]+ arr[0][3][1]
// 	 + arr[0][3][2][0] + arr[0][3][2][1] + arr[1][0] + arr[1][1][0] + arr[1][1][1]);
...
// 	for (let ssubKey in subsubObj){
// 		sum += subsubObj[ssubKey]; 
// 	}	
// 	}
// }
// console.log(sum);
...
// 	console.log(emplo.name + '-' + emplo.salary);
// }
...
// let day = 31;
// let affair = 1;
// console.log(affairs[year][month][day][affair]);
